...
@Docs: 权限系统初始化脚本 - 智能动态权限生成系统
      完全基于Permissions类自动生成权限数据，无需手动维护权限映射
      支持智能权限名称生成和自动类型检测
"""
...
class PermissionInitializer:
    ...
    def _get_role_definitions(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            {
                "role_name": "网络管理员",
                "role_code": "network_admin",
                "description": "网络设备和配置管理员",
                "permissions": [
                    # 网络自动化核心权限
                    ...
                    Permissions.DEVICE_CONNECTION_TEST,
                    Permissions.VENDOR_ACCESS,
                    Permissions.VENDOR_READ,
                    Permissions.REGION_ACCESS,
                    Permissions.REGION_READ,
                    Permissions.QUERY_TEMPLATE_ACCESS,
                    Permissions.QUERY_TEMPLATE_READ,
                    Permissions.VENDOR_COMMAND_ACCESS,
                    Permissions.VENDOR_COMMAND_READ,
                    Permissions.DEVICE_CONFIG_ACCESS,
                    Permissions.DEVICE_CONFIG_READ,
                    Permissions.DEVICE_CONFIG_BACKUP,
                    Permissions.NETWORK_QUERY_ACCESS,
